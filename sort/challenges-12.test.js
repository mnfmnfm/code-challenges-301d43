...
// of two strings. For example, ['Alphabet', 'alphabet', 'carrot', 'Zebra'] is correctly sorted,
...
// firstName, lastName, and age properties, and sorts those people by their last names. (Do not
// worry about capitalization or first names.)
// ------------------------------------------------------------------------------------------------
...
//
// Sort the meetings by the day on which they happen, Monday-Friday. It does not matter which order
// meetings come in on a particular day. For example, if there are two meetings on Monday, it does
// not matter which comes first.
// ------------------------------------------------------------------------------------------------
...
//
// You do NOT need to use the method from challenge 9.
//
...
const sortSchedule = (meetings) => {
  ...
  return sortMeetingsByDay(meetings.sort((a,b) => (Number(a.start) - Number(b.start)) || (Number(a.end) - Number(b.end))));
  // Solution code here...
};
